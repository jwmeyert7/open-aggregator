...
- Different projects never match, however close their categories. A chapter about one protocol or product does not match a story about a competing one, even when both do the same kind of thing.
