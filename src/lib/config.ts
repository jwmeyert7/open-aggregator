...
export function loadPrompt(name: "cluster" | "add-by-url" | "day-summary" | "period-summary" | "source-candidate" | "summary-refresh" | "media-gate" | "chapter-match" | "release-summary"): string {
