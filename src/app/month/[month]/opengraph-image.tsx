...
export const alt = "Monthly review preview";

/** The monthly thread's card: the frozen month's top stories. */
export default async function Image({ params }: { params: Promise<{ month: string }> }) {
  ...
  const label = digest ? `The month in review · ${monthLabel(month)}` : "The month in review";
