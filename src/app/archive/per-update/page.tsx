...
export const metadata = { title: "Per-update archive" };
...
export default async function PerUpdateArchivePage({ searchParams }: { searchParams: Promise<{ date?: string }> }) {
    ...
    <main className="wrap page single">
      <div>
        <div className="section-head">
          <h1>Per-update archive</h1>
          <p>
            Every front page, preserved each time the news changed. Times are UTC. Frozen editions live in the{" "}
            <Link href="/archive">main archive</Link>.
          </p>
